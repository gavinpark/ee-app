    ...
    return (
      ...
      <div className="databaseInfo">
        ...
        <div className="infoExitBox cursorPoint">
          <img className="infoExitSvg cursorPoint" onClick={this.props.toggleDetailPanel} src="http://ellengallery.concordia.ca/establishing-a-database-connection/static/media/info_Exit_Button.svg" alt=""></img>
        </div>
